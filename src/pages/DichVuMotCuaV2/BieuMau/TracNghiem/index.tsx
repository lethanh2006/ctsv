...
const KhaoSat = () => {
    ...
    },
    {
      ...
      render: (val: boolean, record: BieuMau.Record) => (
        <Popconfirm
          title={
            val
              ? 'Bạn có muốn bỏ kích hoạt bài thi trắc nghiệm không?'
              : 'Bạn có muốn kích hoạt bài thi trắc nghiệm không?'
          }
          onConfirm={() => handleChangeStatus(record)}
        >
          <Switch checkedChildren="Mở" unCheckedChildren="Đóng" checked={val} />
        </Popconfirm>
      ),
    },
    {
  ...
  return (
    <TableBase
      ...
      getData={
        access.quanTri
          ? () => getBieuMauAdminHeModel('Trắc nghiệm')
          : () => getBieuMauAdminModel('Trắc nghiệm')
      }
      loading={loading}
