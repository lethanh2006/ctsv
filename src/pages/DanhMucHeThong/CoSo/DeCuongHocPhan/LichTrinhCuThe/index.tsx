...
const LichTrinhCuTheList = () => {
  ...
  return (
    <Row gutter={[12, 12]}>
      {maxWeek ? (
        <Col span={24}>
          <Button icon={<MenuOutlined />} type="primary" onClick={onExpandAll}>
            Xem đầy đủ
          </Button>
        </Col>
      ) : null}
      ...
      <Col span={24}>
        <Collapse
          ...
          onChange={(key) => setActiveKeys(typeof key !== 'string' ? key : [key])}
        >
          {groupLichTrinh
                  ...
                  header={
                    <Space>
                      ...
                      <Button
                        ...
                        icon={<PlusOutlined />}
                        type="link"
                        onClick={() => onAddNew(parseInt(week))}
                      >
                        Thêm nội dung
                      </Button>
                    </Space>
