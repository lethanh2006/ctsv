...
const FormKhenThuong = () => {
	...
	const { record, setVisibleForm, edit, postModel, putModel, getModel, formSubmiting, setRecord, setEdit } =
	...
	const getData = () =>
		getModel(undefined, undefined, undefined, undefined, undefined, `page/sso-id/${hoSoSinhVien?.ssoId}`);
		...
		<Card title={edit ? 'Chỉnh sửa' : 'Thêm mới'}>
			<Form onFinish={onFinish} form={form} layout='vertical'>
				<Row gutter={[12, 0]} style={{ marginBottom: 12 }}>
					...
					<Col span={24}>
						<Form.Item name='soQuyetDinhKhenThuong' label='Số quyết định khen thưởng' rules={[...rules.required]}>
					...
					<Col span={24}>
						<Form.Item name='phuongThucKhenThuong' label='Phương thức khen thưởng' rules={[...rules.required]}>
							<Select
								style={{ width: '100%' }}
