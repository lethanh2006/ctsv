...
const VanBanHuongDanComponent = () => {
  ...
  const handleEdit = (thuMuc: VanBanHuongDan.IRecord) => {
    setEdit(true);
    setRecord(thuMuc);
    setVisibleForm(true);
  };
  ...
  const handleAdd = () => {
    setEdit(false);
    setVisibleForm(true);
    setRecord({} as VanBanHuongDan.IRecord);
  };
  ...
  const showFileList = (thuMuc: VanBanHuongDan.IRecord) => {
  ...
  return (
    <>
      <Card title="Quản lý văn bản hướng dẫn">
        <>
...
export default VanBanHuongDanComponent;
