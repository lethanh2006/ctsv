...
import { HoatDongChung } from '@/services/HoatDongChung/typings';
...
const DanhSachSinhVien = (props: IProps) => {
	...
	const { getModel, condition, page, limit, loading } = useModel('danhsachsinhvienhoatdong');
		...
		<>
			<Spin spinning={loading}>
				...
				>
					...
					>
						<Tabs.TabPane tab='Danh sách sinh viên đăng ký' key='dang-ky'></Tabs.TabPane>
						<Tabs.TabPane tab='Danh sách sinh viên tham gia' key='tham-gia'></Tabs.TabPane>
					</Tabs>
				</TableBase>
			</Spin>
			<Modal
