...
/**
 * Giảng viên cập nhật nội dung cho từng buổi học
 * @param  {number} idBuoiHoc Id Buổi học
 * @param  {any} dataBuoiHoc Data buổi học: tieu_de_bai_hoc, noi_dung_bai_hoc, url_bai_hoc
 */
export async function giangVienLuuThongTinBuoiHoc(idBuoiHoc: number, dataBuoiHoc: any) {
  return axios.put(`${ip3}/odoo-buoi-hoc/${idBuoiHoc}/giang-vien`, dataBuoiHoc);
}
