...
export const getDataThongKeExcel = (payload?: { thongKeId: string; filters: string[] }) => {
	return axios.post(`${ip3}/thong-ke-cdsv/execute/excel`, payload, { responseType: 'arraybuffer' });
};
